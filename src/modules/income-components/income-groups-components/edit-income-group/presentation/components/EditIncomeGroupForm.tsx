...
import {
  ...
  EditIncomeGroupFormSchema,
} from "@/modules/income-components/income-groups-components/edit-income-group/presentation/validation/schema"
import {
  getIncomeGroupById,
  updateIncomeGroup,
...
export function EditIncomeGroupForm({ id }: { id: string }) {
  ...
  async function onSubmit(data: IncomeGroup.UpdateRequest) {
    try {
      ...
      toast.error("Erro ao editar item de receita: " + error)
    }
  }
